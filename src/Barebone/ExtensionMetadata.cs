...
namespace Barebone
{
  public class ExtensionMetadata : IExtensionMetadata
  {
    public IEnumerable<StyleSheet> StyleSheets
    {
      get
      {
        return new StyleSheet[]
        {
          ...
          new StyleSheet("/Styles.min.css", 200),
          new StyleSheet("/Styles.barebone.css", 300)
        };
      }
    }
    ...
    public IEnumerable<MenuItem> MenuItems => new MenuItem[] {new MenuItem("/Account/Logout", "Logout", 1000) };
  }
}